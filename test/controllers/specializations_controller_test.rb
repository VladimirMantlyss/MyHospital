...
class SpecializationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialization" do
    assert_difference("Specialization.count") do
      post specializations_url, params: { specialization: { description: @specialization.description, name: @specialization.name } }
    end
  ...
  test "should update specialization" do
    patch specialization_url(@specialization), params: { specialization: { description: @specialization.description, name: @specialization.name } }
